                                ...
                                <Layout>
                                    ...
                                    <Layout style={{ padding: '0' }}>
                                        <Content style={{ background: '#fff', margin: 0, minHeight: 280 }}>
                                            <Switch>
                                                <Route exact path="/front/companyCulture/1" component={ContentInfo1} />
                                                <Route exact path="/front/companyCulture/2" component={ContentInfo2} />
                                                <Route exact path="/front/companyCulture/3" component={ContentInfo3} />
                                                <Route exact path="/front/companyCulture/4" component={ContentInfo4} />
                                            </Switch>
                                        </Content>
                                    </Layout>
                                </Layout>
