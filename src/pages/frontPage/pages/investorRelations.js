...
export default class InvestorRelations  extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            lineHeight: '62px'
                                ...
                                <Layout>
                                    ...
                                    <Layout style={{ padding: '0' }}>
                                        <Content style={{ background: '#fff', margin: 0, minHeight: 280 }}>
                                            <Switch>
                                                <Route exact path="/front/investorRelations/1" component={ContentInfo1} />
                                                <Route exact path="/front/investorRelations/2" component={ContentInfo2} />
                                                <Route exact path="/front/investorRelations/3" component={ContentInfo3} />
                                                <Route exact path="/front/investorRelations/4" component={ContentInfo4} />
                                            </Switch>
                                        </Content>
                                    </Layout>
                                </Layout>
